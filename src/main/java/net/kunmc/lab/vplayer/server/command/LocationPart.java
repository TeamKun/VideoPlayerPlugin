...
public class LocationPart {
    public static final SimpleCommandExceptionType EXPECTED_DOUBLE = new SimpleCommandExceptionType(new LiteralMessage("小数点型が必要です"));
    public static final SimpleCommandExceptionType EXPECTED_INT = new SimpleCommandExceptionType(new LiteralMessage("整数型が必要です"));
